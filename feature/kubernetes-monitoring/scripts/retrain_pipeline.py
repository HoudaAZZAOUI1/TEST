...
def preprocess_data():
    ...
    return run_command("python data_preprocessing.py", cwd="../data-preprocessing")
...
def train_model():
    ...
    return run_command("python recommendation_model.py", cwd="../ml-model")
...
def run_smoke_tests():
    ...
    # Run smoke tests
    return run_command(f"bash smoke-test.sh", cwd="../ci-cd-pipeline/scripts")
